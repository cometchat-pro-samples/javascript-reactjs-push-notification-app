  ...
  function getHeader() {
    return (
      <div style={headerStyle(theme)}>
        ...
        <div style={versionStyle(theme)}>v4.0.0</div>
      </div>
    );
  }
  ...
  function getContent() {
    return (
      <div style={contentContainerStyle()}>
        ...
        <img src={Image} alt='Login signup' style={imageStyle(!isMobileView)} />
      </div>
    );
  }

  function getFooter() {
    return <div style={footerStyle(theme)}>2023 ⓒ CometChat</div>;
  }
